...
use({
  ...
  config = function()
    ...
    vim.api.nvim_set_hl(0, 'IlluminatedWordText', { bg = '#30323E' })
    vim.api.nvim_set_hl(0, 'IlluminatedWordRead', { bg = '#30323E' })
    vim.api.nvim_set_hl(0, 'IlluminatedWordWrite', { bg = '#30323E' })
  end,
})
